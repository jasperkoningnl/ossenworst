...
export const sourceSeeds: SourceSeed[] = [
  ...
  { name: "Google News: Parool Ajax", slug: "gnews-parool", url: "https://www.parool.nl", tier: 2, country: "NL", language: "nl", fetchMethod: "rss", feedUrl: "https://news.google.com/rss/search?q=site:parool.nl+Ajax&hl=nl&gl=NL&ceid=NL:nl", enabled: true },
  { name: "Google News: Ajax ES", slug: "gnews-ajax-es", url: "https://news.google.com", tier: 3, country: "ES", language: "es", fetchMethod: "rss", feedUrl: "https://news.google.com/rss/search?q=%22Ajax+Amsterdam%22&hl=es&gl=ES&ceid=ES:es", enabled: true },
  { name: "Google News: Ajax IT", slug: "gnews-ajax-it", url: "https://news.google.com", tier: 3, country: "IT", language: "it", fetchMethod: "rss", feedUrl: "https://news.google.com/rss/search?q=%22Ajax+Amsterdam%22&hl=it&gl=IT&ceid=IT:it", enabled: true },
  { name: "Google News: Ajax DE", slug: "gnews-ajax-de", url: "https://news.google.com", tier: 3, country: "DE", language: "de", fetchMethod: "rss", feedUrl: "https://news.google.com/rss/search?q=%22Ajax+Amsterdam%22&hl=de&gl=DE&ceid=DE:de", enabled: true },
  { name: "Google News: Ajax FR", slug: "gnews-ajax-fr", url: "https://news.google.com", tier: 3, country: "FR", language: "fr", fetchMethod: "rss", feedUrl: "https://news.google.com/rss/search?q=%22Ajax+Amsterdam%22&hl=fr&gl=FR&ceid=FR:fr", enabled: true },
  { name: "Google News: Ajax PT", slug: "gnews-ajax-pt", url: "https://news.google.com", tier: 3, country: "PT", language: "pt", fetchMethod: "rss", feedUrl: "https://news.google.com/rss/search?q=%22Ajax+Amsterdam%22&hl=pt&gl=PT&ceid=PT:pt", enabled: true },
  { name: "Google News: Ajax BR", slug: "gnews-ajax-br", url: "https://news.google.com", tier: 3, country: "BR", language: "pt-BR", fetchMethod: "rss", feedUrl: "https://news.google.com/rss/search?q=%22Ajax+Amsterdam%22&hl=pt-BR&gl=BR&ceid=BR:pt-419", enabled: true },
  { name: "Google News: Ajax TR", slug: "gnews-ajax-tr", url: "https://news.google.com", tier: 3, country: "TR", language: "tr", fetchMethod: "rss", feedUrl: "https://news.google.com/rss/search?q=%22Ajax+Amsterdam%22&hl=tr&gl=TR&ceid=TR:tr", enabled: true },
];
